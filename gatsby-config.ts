        ...
        options: {
          ...
          locales: [
            ...
            },
            {
              ...
              slugs: {
                '/past': '/vergangenheit',
                '/past#first': '/vergangenheit#erster',
                '/past#second': '/vergangenheit#zweiter',
                '/present': '/gegenwart',
                '/present#first': '/gegenwart#erster',
                '/present#second': '/gegenwart#zweiter',
                '/present#third': '/gegenwart#dritter',
                '/future': '/zukunft',
                '/future#first': '/zukunft#erster',
                '/future#second': '/zukunft#zweiter',
                '/imprint': '/impressum',
              },
